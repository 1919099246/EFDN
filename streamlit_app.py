...
parser.add_argument('--lr_path', type=str, default=r'.\images\Set5\LR_bicubic\X4')
parser.add_argument('--hr_path', type=str, default=r'.\images\Set5\HR')
parser.add_argument('--results', type=str, default=r'.\results')
parser.add_argument('--onnxfile', type=str, default=r'.\models\RLFNx4.onnx')
parser.add_argument('--enginefile', type=str, default=r'.\models\engines\RLFN_FP32x4.engine')
parser.add_argument('--model', type=str, default='RLFN')
